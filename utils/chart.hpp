...
namespace utils
{
  ...
  public:
    ...
    typedef typename chart_type::differencve_type difference_type;
  ...
  public:
    ...
    chart(size_type __s, const value_type& __v) : __chart(__chart_size(__s), __v), _size(__s) {}
  ...
  public:
    ...
    void resize(size_type __s) { __chart.resize(__chart_size(__s)); __size = _s; }
    ...
    inline const_iterator end(size_type length) const { return __chart.begin() + __position(length, _size); }
    inline iterator       end(size_type length)       { return __chart.begin() + __position(length, _size); }
