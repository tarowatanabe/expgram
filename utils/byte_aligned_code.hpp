...
namespace utils
{
  ...
  struct __byte_aligned_code<Tp, 2>
  {
    ...
    size_t encode(Tp x, char* buf)
    {
      ...
      switch (__size) {
      case 3: buf[2] = (x >> 14) & 0x7f;
      case 2: buf[1] = (x >>  7) & 0x7f;
      case 1: buf[0] = (x      ) & 0x7f;
      }
      buf[__size - 1] |= 0x80;
      return __size;
  ...
  struct __byte_aligned_code<Tp, 4>
  {
    ...
    size_t encode(Tp x, char* buf)
    {
      ...
      const size_t __size = byte_size(x);
      switch (__size) {
      case 5: buf[4] = (x >> 28) & mask;
      case 4: buf[3] = (x >> 21) & mask;
      case 3: buf[2] = (x >> 14) & mask;
      case 2: buf[1] = (x >>  7) & mask;
      case 1: buf[0] = (x      ) & mask;
      }
      buf[__size - 1] |= 0x80;
      return __size;
  ...
  struct __byte_aligned_code<Tp, 8>
  {
    ...
    size_t encode(Tp x, char* buf)
    {
      ...
      switch (__size) {
      case 10: buf[9] = (uvalue >> 63) & mask;
      case  9: buf[8] = (uvalue >> 56) & mask;
      case  8: buf[7] = (uvalue >> 49) & mask;
      case  7: buf[6] = (uvalue >> 42) & mask;
      case  6: buf[5] = (uvalue >> 35) & mask;
      case  5: buf[4] = (uvalue >> 28) & mask;
      case  4: buf[3] = (uvalue >> 21) & mask;
      case  3: buf[2] = (uvalue >> 14) & mask;
      case  2: buf[1] = (uvalue >>  7) & mask;
      case  1: buf[0] = (uvalue      ) & mask;
      }
      buf[__size - 1] |= 0x80;
      return __size;
    }
