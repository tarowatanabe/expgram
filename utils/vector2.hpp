...
namespace utils
{
  ...
  public:
    ...
    vector2(size_type _size1, size_type _size2)
      : __base(_size1 * _size2), __size1(_size1), __size2(_size2) {}
    vector2(size_type _size1, size_type _size2, const value_type& value)
      : __base(_size1 * _size2, value), __size1(_size1), __size2(_size2) {}
    
    bool empty() const { return __base.empty(); }
    size_type size1() const { return __size1; }
    size_type size2() const { return __size2; }
    
    void reserve(size_type pos1, size_type pos2)
    {
      __base.reserve(pos1 * pos2);
    }
    
    void resize(size_type pos1, size_type pos2)
    {
      __size1 = pos1;
      __size2 = pos2;
      __base.resize(pos1 * pos2);
    }
    void resize(size_type pos1, size_type pos2, const value_type& value)
    {
      __size1 = pos1;
      __size2 = pos2;
      __base.resize(pos1 * pos2, value);
    }
    void clear()
    {
      __base.clear();
