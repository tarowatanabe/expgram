...
#ifndef __EXPGRAM__DISCOUNT__HPP__
#define __EXPGRAM__DISCOUNT__HPP__ 1

//
// modified-KN/KN smoothing discounting with optional fall-back to witten-bell smoothing...
//
