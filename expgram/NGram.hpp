...
namespace expgram
{
  ...
  public:
    ...
    std::pair<logprob_type, state_type> logbound(state_type state, const _Word& word) const
    {
    ...
    template <typename _Word>
    std::pair<logprob_type, state_type> logprob(state_type state, const _Word& word) const
    {
