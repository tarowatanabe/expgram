...
#ifndef __EXPGRAM__SENTENCE__HPP__
#define __EXPGRAM__SENTENCE__HPP__ 1
...
namespace expgram
{
  ...
  public:
    ...
    inline const_reference operator()(size_type pos) const { return (pos == 0 ? vocab_type::NONE : __sent[pos - 1]); }
...
{
  inline
  void swap(expgram::Sentence& x, expgram::Sentence& y)
  {
    x.swap(y);
  }
};
